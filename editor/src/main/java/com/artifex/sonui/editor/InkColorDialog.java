...
public class InkColorDialog implements View.OnTouchListener, PopupWindow.OnDismissListener {
    ...
    private static InkColorDialog singleton = null;
    ...
    //  constructor
    public InkColorDialog(int dialogType, Context context, View anchor, ColorChangedListener listener, boolean autoDismiss)
    {
        mContext = context;
        mAnchor = anchor;
        mListener = listener;
