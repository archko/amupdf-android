...
JNICALL
Java_org_ebookdroid_core_crop_PageCropper_nativeGetCropBounds(JNIEnv *env, jclass clz,
...
JNICALL
Java_org_ebookdroid_core_crop_PageCropper_nativeGetColumn(JNIEnv *env, jclass clz, jobject pixels,
                                                          jint width,
