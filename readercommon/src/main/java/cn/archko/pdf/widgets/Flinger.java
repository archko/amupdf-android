...
public class Flinger {
    ...
    public void startScroll(final int startX, final int startY, final int dx, final int dy) {
        try {
            ...
            if (DEFAULT_DURATION > 0) {
                final double velocityX = (double) (finalX - startX) / (DEFAULT_DURATION / 1000f);
                final double velocityY = (double) (finalY - startY) / (DEFAULT_DURATION / 1000f);
                final double velocity = Math.hypot(velocityX, velocityY);
                currVelocity = (int) velocity;
    ...
    public void startScroll(final int startX, final int startY, final int dx, final int dy, int duration) {
