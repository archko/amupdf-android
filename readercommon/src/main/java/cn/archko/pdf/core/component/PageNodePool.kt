...
public class PageNodePool {
    ...
    // 获取一个 Node，如果没有则新建
    public fun acquire(pageViewState: PageViewState, bounds: RectF, aPage: APage): PageNode {
        ...
        return if (node != null) {
            ...
            PageNode(pageViewState, Rect(bounds.left.toInt(), bounds.top.toInt(), bounds.right.toInt(), bounds.bottom.toInt()), aPage)
        }
    }
