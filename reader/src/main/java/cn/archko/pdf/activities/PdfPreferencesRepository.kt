...
object PreferencesKeys {
    ...
    val PREF_AUTOCROP = intPreferencesKey("autocrop")
...
class PdfPreferencesRepository(private val dataStore: DataStore<Preferences>) {
    ...
    val pdfPreferencesFlow: Flow<UserPreferences> = dataStore.data
        .catch { exception ->
            ...
            val showExtension = preferences[PreferencesKeys.PREF_SHOW_EXTENSION] ?: false
            val fullscreen = preferences[PreferencesKeys.PREF_FULLSCREEN] ?: false
            val autocrop = preferences[PreferencesKeys.PREF_AUTOCROP] ?: 0
            val verticalScrollLock = preferences[PreferencesKeys.PREF_VERTICAL_SCROLL_LOCK] ?: false
    ...
    suspend fun setAutocrop(autocrop: Int) {
        dataStore.edit { preferences ->
