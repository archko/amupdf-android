...
public class FastScroller {
    ...
    private int mThumbActiveColor = 0x79000000;
    private int mThumbInactiveColor = 0x79000000;
    private boolean mThumbInactiveState = true;
    ...
    public FastScroller(Context context, FastScrollRecyclerView recyclerView, AttributeSet attrs) {
        ...
        mTrack.setColor(Color.parseColor("#28000000"));
        ...
        mRecyclerView.addOnScrollListener(new ARecyclerView.OnScrollListener() {
            @Override
            public void onScrolled(@NonNull ARecyclerView recyclerView, int dx, int dy) {
    ...
    public void draw(Canvas canvas) {
        ...
        //Handle
        rect.set(mThumbPosition.x + mOffset.x + (float) (mThumbWidth - mTrackWidth) / 2,
                mThumbPosition.y + mOffset.y,
                mThumbPosition.x + mOffset.x + mThumbWidth + (float) (mThumbWidth - mTrackWidth) / 2,
