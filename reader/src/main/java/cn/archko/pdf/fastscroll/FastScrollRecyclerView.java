...
public class FastScrollRecyclerView extends ARecyclerView implements ARecyclerView.OnItemTouchListener {
     ...
     */
    @Override
    public boolean onInterceptTouchEvent(@NonNull ARecyclerView rv, @NonNull MotionEvent ev) {
        return handleTouchEvent(ev);
    }

    @Override
    public void onTouchEvent(@NonNull ARecyclerView rv, @NonNull MotionEvent ev) {
        handleTouchEvent(ev);
    }
    ...
    public interface MeasurableAdapter<VH extends ViewHolder> {
         ...
         */
        int getViewTypeHeight(ARecyclerView recyclerView, @Nullable VH viewHolder, int viewType);
    }
}